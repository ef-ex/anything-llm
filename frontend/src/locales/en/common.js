const TRANSLATIONS = {
  ...
  chat_window: {
    ...
    vela_entities: {
      title: "Vela Entities",
      unavailable:
        "Vela backend is not reachable. Set VELA_API_URL on the AnythingLLM server.",
      project_label: "Active Vela project",
      no_project: "— No project bound —",
      resolved_via: "Resolved via {{source}}",
      set_user_default: "Set as my default project",
      bind_project_hint: "Select a Vela project above to browse entities.",
      all_types: "All types",
      search_placeholder: "Search entities…",
      loading: "Loading…",
      empty: "No entities in this project.",
      pinned_version: "Pinned version",
      current_pin: "Pinned",
      reference_builder: "Reference",
      version_default: "Default (pinned / latest)",
      include_media: "Include media in preview",
      context_preview: "Context preview",
      refresh_preview: "Refresh",
      no_active_project: "No active project resolved.",
      path_preview: "Output path (dry-run)",
      run_path_resolve: "Resolve path via API",
      publish_optional: "Publish (optional)",
    ...
    vela_orchestrator: {
      ...
      status_needs_user_input: "Needs your input",
      no_role: "Selecting role…",
      answer_placeholder: "Your answer or role id",
      resume: "Continue",
      provider: "Provider",
      selection: "Selection",
      route_reason: "Route",
